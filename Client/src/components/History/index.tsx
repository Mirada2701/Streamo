...
import { IGetVideoListHistoryResult, IVideoLookup } from "../../pages/Video/common/types";
            ...
            <div className="item flex mx-11 my-5 text-gray">
                <Link to={'/video/watch/' + props.video.id}>
                    <img
                        ...
                        src={APP_CONFIG.API_URL+`/api/photo/getPhotoUrl/${props.video.previewPhotoFile}/600`}
                    />
                </Link>
                        ...
                        <div className="flex">
                            <div className="w-12 h-12 mr-5">
                                <img
                                    ...
                                    src={APP_CONFIG.API_URL+`/api/photo/getPhotoUrl/${props.video.creator?.channelPhoto}/600`}
                                    alt="User"
                                />
                            </div>
...
export const HistoryVideoContainer = () => {
    ...
    useEffect(() => {
        ...
        const loadVideoAsync = async () => {
            ...
            const result = (
                await http_api.get<IGetVideoListHistoryResult>(`/api/video/getVideoListHistory?Page=${page}&PageSize=${pageSize}`)
            ).data;
