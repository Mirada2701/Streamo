...
using MEGUTube.WebApi.DTO.Videos;
...
using MEGUTube.Application.CQRS.UserVideoHistories.Queries.GetUserVideoHistoryList;
using MEGUTube.Application.CQRS.Videos.Queries.GetRandomVideo;
...
namespace MEGUTube.WebApi.Controllers
{
    public class VideoController : BaseController
    {
        ...
        public async Task<ActionResult> GetVideoUrl([FromQuery] GetVideoUrlDto dto)
        {
            ...
            String url = $"{domain}/videos/{dto.VideoFileId}.mp4";
